...
class UserServiceImplTest {
    ...
    void testRegisterUser_NullRequest_ThrowsException() {
        CarException ex = assertThrows(CarException.class, () -> userService.register(null));
    ...
    void testRegisterWhenPasswordDoNotMatch_ThrowsException() {
        ...
        CarException ex = assertThrows(CarException.class, () -> userService.register(registerRequest));
    }
    ...
    void testFindUserWithNullId(){
        assertThrows(CarException.class, () -> userService.findUserById(null));
    }

    @Test
    void testFindUserThatDoesNotExist(){
        firstUserId = 10000000L;
        assertThrows(CarException.class, () -> userService.findUserById(firstUserId));
    }
    ...
    void loginUserWithWrongPassword(){
        ...
        assertThrows(CarException.class, ()->userService.login(loginRequest));
    }
